...
export default function EternityPage() {
  return (
    <div className="page">
      ...
      <p className='chemical'>You will get a long sentence with words, interpret those words to form a sentence, then take the first letter of each word to form the key to the door</p><br/>
